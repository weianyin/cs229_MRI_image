...
def load_dataset(split, directory="", show=False, option=ImageProcessingOption.Flatten):
    """
    ...
    directory = "/Users/weianyin/Documents/Workspaces/cs229_MRI_image/archive"

    # Loads the processed dataset if it exists
    numpy_filepath = os.path.join(directory, f"{split}_{option}_string.npz")
...
def load_datasets(directory="", option=ImageProcessingOption.Flatten):
